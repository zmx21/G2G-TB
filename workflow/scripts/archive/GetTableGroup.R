...
write.table(PC_Dist,file = '~/G2G_TB/results/Host_PC_Dist.txt')
PC_Dist_Patient_ID <- PC_Dist
rownames(PC_Dist_Patient_ID) <- sapply(rownames(PC_Dist_Patient_ID),function(x) gsub(x=x,pattern = 'Batch1_',replacement = ''))
rownames(PC_Dist_Patient_ID) <- sapply(rownames(PC_Dist_Patient_ID),function(x) gsub(x=x,pattern = 'Batch2_',replacement = ''))
rownames(PC_Dist_Patient_ID) <- sapply(rownames(PC_Dist_Patient_ID),function(x) gsub(x=x,pattern = 'WGS_Fellay.',replacement = ''))
colnames(PC_Dist_Patient_ID) <- rownames(PC_Dist_Patient_ID)

write.table(PC_Dist_Patient_ID,file = '~/G2G_TB/results/Host_PC_Dist_Patient_ID.txt',row.names = T,col.names = T)
